...
$.extend($.validator, {
	...
	messages: {
		...
		accept: "Lütfen geçerli bir uzantı girin.",
		maxlength: $.validator.format("Lütfen en fazla {0} karakter girin."),
		minlength: $.validator.format("Lütfen en az {0} karakter girin."),
		rangelength: $.validator.format("Lütfen {0} ve {1} arasında uzunluğa sahip karakter girin."),
		range: $.validator.format("Lütfen {0} ve {1} arasında bir değer girin."),
		max: $.validator.format("Lütfen {0} 'a eşit ya da daha küçük bir değer girin."),
		min: $.validator.format("Lütfen {0} 'a eşit ya da daha büyük bir değer girin.")
	},
